...
static LLVMValueRef emit_logical_expr(struct codegen *codegen, struct ast_expr_binary *binary,
                                      struct ast_ty *ty);
static LLVMValueRef emit_boolean_expr(struct codegen *codegen, struct ast_expr_binary *binary);
static LLVMValueRef emit_binary_expr(struct codegen *codegen, struct ast_expr_binary *binary,
                                     struct ast_ty *ty);
