...
macro(add_bootstrap_haven_library name source)
    ...
    add_custom_command(
        ...
        COMMAND haven_bootstrap -I /usr/include --O2 ${CMAKE_CURRENT_SOURCE_DIR}/${source} -o ${CMAKE_CURRENT_BINARY_DIR}/${name}.o
...
macro(add_haven_library name source)
    ...
    add_custom_command(
        OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${name}.o
        COMMAND haven -I /usr/include --debug-ast --debug-ir --O0 ${CMAKE_CURRENT_SOURCE_DIR}/${source} -o ${CMAKE_CURRENT_BINARY_DIR}/${name}.o
        MAIN_DEPENDENCY ${CMAKE_CURRENT_SOURCE_DIR}/${source}
        DEPENDS haven ${ARGN}
    )
