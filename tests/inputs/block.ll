; ModuleID = './tests/inputs/block.mc'
...
entry:
  ...
  store i1 false, ptr %retval, align 1, !dbg !4
...
!1 = !DIFile(filename: "./tests/inputs/block.mc", directory: "examples")
...
!4 = !DILocation(line: 3, column: 14, scope: !5)
!5 = distinct !DILexicalBlock(scope: !6, file: !1, line: 2, column: 6)
!6 = distinct !DILexicalBlock(scope: !3, file: !1, line: 1, column: 19)
